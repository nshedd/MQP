...
ggsave(path.expand("/home/sheddn/UCLA-ASD/PEC_syn18898607/scRNAseq/10BW_s13/plots/qcvlnplot_ASD.png"), device=, width = 14, height = 7)
...
plot <- plot1 + plot2
ggsave(path.expand("/home/sheddn/UCLA-ASD/PEC_syn18898607/scRNAseq/10BW_s13/plots/featurescatter_ASD.png"), device=, width = 14, height = 7)
...
ggsave(path.expand("/home/sheddn/UCLA-ASD/PEC_syn18898607/scRNAseq/10BW_s13/plots/qcdimloadings_ASD.png"), device=, width = 14, height = 7)

pca_plot_ASD <- DimPlot(ASD, reduction = "pca")
ggsave(path.expand("/home/sheddn/UCLA-ASD/PEC_syn18898607/scRNAseq/10BW_s13/plots/pcascatter_ASD.png"), device=, width = 14, height = 7)

pca_heatmap_ASD <- DimHeatmap(ASD, dims = 1, balanced = TRUE)
ggsave(path.expand("/home/sheddn/UCLA-ASD/PEC_syn18898607/scRNAseq/10BW_s13/plots/pcaheatmap_ASD.png"), device=, width = 14, height = 7)

ASD <- JackStraw(ASD, num.replicate = 100)
ASD <- ScoreJackStraw(ASD, dims = 1:20)
Jackstraw_ASD <- JackStrawPlot(ASD, dims = 1:15)
ggsave(path.expand("/home/sheddn/UCLA-ASD/PEC_syn18898607/scRNAseq/10BW_s13/plots/jackstrawplot_ASD.png"), device=, width = 14, height = 7)

Elbow_ASD <- ElbowPlot(ASD)
ggsave(path.expand("/home/sheddn/UCLA-ASD/PEC_syn18898607/scRNAseq/10BW_s13/plots/elbowplot_ASD.png"), device=, width = 14, height = 7)
...
ggsave(path.expand("/home/sheddn/UCLA-ASD/PEC_syn18898607/scRNAseq/10BW_s13/plots/umap_ASD_orgident.png"), device=)
...
ggsave(path.expand("/home/sheddn/UCLA-ASD/PEC_syn18898607/scRNAseq/10BW_s13/plots/Dotplot_ASD.png"), device=)
...
write.table(diff_expressed, file = path.expand("/home/sheddn/UCLA-ASD/PEC_syn18898607/scRNAseq/10BW_s13/plots/umap_ASD_diffexpressed.txt"), sep = '\t')

write.table(diff_expressed_condensed, file = path.expand("/home/sheddn/UCLA-ASD/PEC_syn18898607/scRNAseq/10BW_s13/plots/umap_ASD_diffexpressed_condensed.txt"), sep = '\t')

FeaturePlot(ASD, features = c("SLC17A7", "GRIN1", "GRIN2B"))
ggsave(path.expand("/home/sheddn/UCLA-ASD/PEC_syn18898607/scRNAseq/10BW_s13/plots/ASD_ExcitatoryFeatures.png"), device=)

FeaturePlot(ASD, features = c("GAD1", "GAD2", "SLC6A1"))
ggsave(path.expand("/home/sheddn/UCLA-ASD/PEC_syn18898607/scRNAseq/10BW_s13/plots/ASD_InhibitoryFeatures.png"), device=)

FeaturePlot(ASD, features = c("CLDN11", "MOG", "MOBP", "MBP"))
ggsave(path.expand("/home/sheddn/UCLA-ASD/PEC_syn18898607/scRNAseq/10BW_s13/plots/ASD_OligodendrocyteFeatures.png"), device=)

FeaturePlot(ASD, features = c("GFAP", "SLC1A2", "SLC1A3", "SLC4A4", "AQP4"))
ggsave(path.expand("/home/sheddn/UCLA-ASD/PEC_syn18898607/scRNAseq/10BW_s13/plots/ASD_AstrocyteFeatures.png"), device=)

FeaturePlot(ASD, features = c("COBLL1", "DUSP1", "FLT1"))
ggsave(path.expand("/home/sheddn/UCLA-ASD/PEC_syn18898607/scRNAseq/10BW_s13/plots/ASD_EndothelialFeatures.png"), device=)

FeaturePlot(ASD, features = c("COBLL1", "PDGFRB", "COBLL1", "PDGFRB"))
ggsave(path.expand("/home/sheddn/UCLA-ASD/PEC_syn18898607/scRNAseq/10BW_s13/plots/ASD_PericyteFeatures.png"), device=)

FeaturePlot(ASD, features = c("PCDH15"))
ggsave(path.expand("/home/sheddn/UCLA-ASD/PEC_syn18898607/scRNAseq/10BW_s13/plots/ASD_OPCFeatures.png"), device=)

FeaturePlot(ASD, features = c("APBB1IP", "P2RY12", "PTPRC"))
ggsave(path.expand("/home/sheddn/UCLA-ASD/PEC_syn18898607/scRNAseq/10BW_s13/plots/ASD_MicrogliaFeatures.png"), device=)

FeaturePlot(ASD, features = c("RYR1"))
ggsave(path.expand("/home/sheddn/UCLA-ASD/PEC_syn18898607/scRNAseq/10BW_s13/plots/ASD_PurkinjeFeatures.png"), device=)

FeaturePlot(ASD, features = c("RELN", "GRM4", "RBFOX3"))
ggsave(path.expand("/home/sheddn/UCLA-ASD/PEC_syn18898607/scRNAseq/10BW_s13/plots/ASD_GranuleFeatures.png"), device=)
