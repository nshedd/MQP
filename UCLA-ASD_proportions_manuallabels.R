...
colnames(ASD_BA4.6_prop_df) <- c('Cell_Type', 'Freq')

ggplot(data=ASD_BA4.6_prop_df, aes(x = Cell_Type, y = Freq)) + geom_histogram(stat="identity") +ggtitle("ASD - BA 4/6 - Cluster Labels")
ggsave('/data/rusers/sheddn/UCLA-ASD/plots/ASD_CellTypeProportion_BA4.6.png')
...
saveRDS(ASD, '/data/rusers/sheddn/UCLA-ASD/data/CTL_UMAPprocessed_BySample_Harmony_BA9_DoubletsRemoved_Relabeled.RDS')
...
colnames(ASD_BA9_prop_df) <- c('Cell_Type', 'Freq')

ggplot(data=ASD_BA9_prop_df, aes(x = Cell_Type, y = Freq)) + geom_histogram(stat="identity") +ggtitle("ASD - BA 9 - Cluster Labels")
ggsave('/data/rusers/sheddn/UCLA-ASD/plots/ASD_CellTypeProportion_BA9.png')
...
colnames(CTL_BA4.6_prop_df) <- c('Cell_Type', 'Freq')

ggplot(data=CTL_BA4.6_prop_df, aes(x = Cell_Type, y = Freq)) + geom_histogram(stat="identity") +ggtitle("CTL - BA 4/6 - Cluster Labels")
ggsave('/data/rusers/sheddn/UCLA-ASD/plots/CTL_CellTypeProportion_BA4.6.png')
...
colnames(CTL_BA9_prop_df) <- c('Cell_Type', 'Freq')

ggplot(data=CTL_BA9_prop_df, aes(x = Cell_Type, y = Freq)) + geom_histogram(stat="identity") +ggtitle("CTL - BA 9 - Cluster Labels")
ggsave('/data/rusers/sheddn/UCLA-ASD/plots/CTL_CellTypeProportion_BA9.png')
