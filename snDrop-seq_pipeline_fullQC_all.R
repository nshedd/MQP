...
ggsave(path.expand("~/Lake/All/qcvlnplot_GSE97930_All_Seurat.png"), device=)
...
plot <- plot1 + plot2
ggsave(path.expand("~/Lake/All/featurescatter_GSE97930_All_Seurat.png"), device=)
...
ggsave(path.expand("~/Lake/All/qcdimloadings_GSE97930_All_Seurat.png"), device=)

pca_plot_All <- DimPlot(All, reduction = "pca")
ggsave(path.expand("~/Lake/All/pcascatter_GSE97930_All_Seurat.png"), device=)

pca_heatmap_All <- DimHeatmap(All, dims = 1, balanced = TRUE)
ggsave(path.expand("~/Lake/All/pcaheatmap_GSE97930_All_Seurat.png"), plot=pca_heatmap_All, device=)

All <- JackStraw(All, num.replicate = 100)
All <- ScoreJackStraw(All, dims = 1:20)
Jackstraw_All <- JackStrawPlot(All, dims = 1:15)
ggsave(path.expand("~/Lake/All/jackstrawplot_GSE97930_All_Seurat.png"), device=)
