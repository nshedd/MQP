...
--genomeDir ~/SCZ-BP/ \
--readFilesIn ${work_path2}/10BW_S13_L001_R1_001.fastq, ${work_path2}/10BW_S13_L001_R2_001.fastq  ${work_path2}/10BW_S13_L002_R1_001.fastq, ${work_path2}/10BW_S13_L002_R2_001.fastq\
--soloType Droplet \
