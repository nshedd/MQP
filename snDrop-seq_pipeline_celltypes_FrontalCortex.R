...
FeaturePlot(FrontalCortex, features = c("PCDH15", "OLIG1"))
ggsave(path.expand("~/Lake/FrontalCortex/GSE97930_FrontalCortex_Seurat_OPCFeatures.png"), device=, width = 14, height = 7)
