...
cluster1_genes = genes[genes$group == 1,]
cluster2_genes = genes[genes$group == 2,]
cluster3_genes = genes[genes$group == 3,]
cluster4_genes = genes[genes$group == 4,]
cluster5_genes = genes[genes$group == 5,]
cluster6_genes = genes[genes$group == 6,]
cluster7_genes = genes[genes$group == 7,]
cluster8_genes = genes[genes$group == 8,]
cluster9_genes = genes[genes$group == 9,]
cluster10_genes = genes[genes$group == 10,]
cluster11_genes = genes[genes$group == 11,]
