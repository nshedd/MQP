...
diff_expressed = read.table(path.expand("~/GSE97930_frontalcortex_differentiallyexpressed.txt"), header=TRUE, row.names=1, sep="\t")
...
write.table(diff_expressed_condensed, file = path.expand("~/GSE97930_frontalcortex_differentiallyexpressed_condensed.txt"), sep = '\t')

write.table(diff_expressed_condensed_pres, file = path.expand("~/GSE97930_frontalcortex_differentiallyexpressed_condensed_pres.txt"), sep = '\t')
